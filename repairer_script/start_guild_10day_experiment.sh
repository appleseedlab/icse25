...
tmux new-session -d -s 10day_experiment "timeout 240h ~/opt/syzkaller/bin/syz-manager -config=/home/anon/opt/syzkaller/my.cfg 2>&1 | tee ${syzkaller_output}; exec $SHELL"