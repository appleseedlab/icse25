...
mkdir /home/sanan/opt/syzkaller/syzkaller_default_${syzbot_config_name}_${commit_hash}_$(date +'%m%d%Y')

workdir_name="/home/sanan/opt/syzkaller/syzkaller_default_${syzbot_config_name}_${commit_hash}_$(date +'%m%d%Y')"
...
raw_syz_term_out="/home/sanan/research/syzkaller_default_terminal_output/raw_${syzbot_config_name}_${commit_hash}_${current_date}"
