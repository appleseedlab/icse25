...
# example: bash /data1/paul/kmax/scripts/krepair_syzkaller_evaluation/paper/run_many_cyzkaller_evaluations.sh localhost:45678 linux/ x86_64 formulacache outdir/ ~/Documents/syzkaller |& tee out
